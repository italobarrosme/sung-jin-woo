...
const inputVariants = cva(
  'rounded-md border bg-transparent px-3 py-2 text-sm ring-offset-primary-regular placeholder:text-neutral-grey focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 w-full',
  {
    variants: {
      variant: {
